...
Install Perl modules: C<cpanm DateTime IO::All Mojolicious Mojolicious::Plugin::RenderFile Text::Markdown>

=item *

Start a local webserver: C<cd rexify-website/html && hypnotoad website.pl>
