...
@@ navigation.html.ep
             ...
             <div class="nav_links">
               <ul>
                  ...
                  <li <% if($cat eq "get") { %>class="active" <% } %>><a href="/get" title="Install Rex on your systems">安装 Rex </a></li>
                  <li <% if($cat eq "contribute") { %>class="active" <% } %>><a href="/contribute" title="Help Rex to get even better">贡献Rex</a></li>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
      ...
      % }
         ...
         <div id="widgets_container">
            <div id="widgets">
               ...
               <p>Come and join us, we will do live demostrations with a custom build portable mini datacenter.</p><p>如果你有时间想帮助我们请联系<br /><a href="mailto:lairdnote@gmail.com">中国区@lairdnote <br /> 原作者 <a href="mailto:jfried@rexify.org">@jfried83</a>.</p>
 ...
 % if( ! $no_disqus) {
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'laird-sa'; // required: replace example with your forum shortname
